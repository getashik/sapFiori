jQuery.sap.declare("HybridMaster.dev.devapp");
jQuery.sap.require("HybridMaster.dev.devlogon");

HybridMaster.dev.devapp = {
	smpInfo: {},
	externalURL: null,
	...
	onDeviceReady: function() {
		if (window.sap_webide_FacadePreview) {
			...
			var that = HybridMaster.dev.devapp;
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new HybridMaster.dev.devlogon();
