jQuery.sap.require("HybridMaster.util.Formatter");
jQuery.sap.require("HybridMaster.util.Controller");

HybridMaster.util.Controller.extend("HybridMaster.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(HybridMaster.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "HybridMaster.view.NotFound",
			targetViewType: "XML"
		});
	},
