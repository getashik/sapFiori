jQuery.sap.declare("HybridMaster.Component");
jQuery.sap.require("HybridMaster.dev.devapp");
jQuery.sap.require("HybridMaster.MyRouter");

sap.ui.core.UIComponent.extend("HybridMaster.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		rootView: "HybridMaster.view.App",
		...
		routing: {
			config: {
				routerClass: HybridMaster.MyRouter,
				viewType: "XML",
				viewPath: "HybridMaster.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("HybridMaster");
		...
		var oModel;
		var externalURL = HybridMaster.dev.devapp.externalURL;
		var appContext;
		if (HybridMaster.dev.devapp.devLogon) {
			appContext = HybridMaster.dev.devapp.devLogon.appContext;
		}
